  ...
  <div class="app-container">
    <el-card>
      ...
      <el-form :model="form" :rules="rules" ref="formRef" label-width="120px">
        ...
        <h3 style="margin: 30px 0 15px;">采购信息</h3>
        <el-row :gutter="20">
          <el-col :span="12">
          ...
          <el-col :span="12">
            <el-form-item label="采购价格">
              <el-input v-model="form.purchase_price" type="number" placeholder="单位：元">
        ...
        <h3 style="margin: 30px 0 15px;">保修信息</h3>
        <el-row :gutter="20">
          <el-col :span="12">
            <el-form-item label="保修开始">
              <el-date-picker v-model="form.warranty_start" type="date" placeholder="选择日期" style="width: 100%" value-format="YYYY-MM-DD" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="保修结束">
              <el-date-picker v-model="form.warranty_end" type="date" placeholder="选择日期" style="width: 100%" value-format="YYYY-MM-DD" />
            </el-form-item>
          </el-col>
          <el-col :span="24">
            <el-form-item label="保修服务商">
              <el-input v-model="form.warranty_provider" />
            </el-form-item>
          </el-col>
        </el-row>

        <h3 style="margin: 30px 0 15px;">使用信息</h3>
        <el-row :gutter="20">
          <el-col :span="12">
            <el-form-item label="部署日期">
              <el-date-picker v-model="form.deployment_date" type="date" placeholder="选择日期" style="width: 100%" value-format="YYYY-MM-DD" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="资产状态">
              <el-select v-model="form.asset_status" style="width: 100%">
          ...
          <el-col :span="12" v-if="form.asset_status === 'retired'">
            <el-form-item label="报废日期">
              <el-date-picker v-model="form.retire_date" type="date" placeholder="选择日期" style="width: 100%" value-format="YYYY-MM-DD" />
            </el-form-item>
          </el-col>
          <el-col :span="12" v-if="form.asset_status === 'retired'">
            <el-form-item label="报废原因">
              <el-input v-model="form.retire_reason" />
            </el-form-item>
          </el-col>
        </el-row>

        <h3 style="margin: 30px 0 15px;">其他信息</h3>
        <el-row :gutter="20">
          <el-col :span="24">
