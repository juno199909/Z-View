<template>
  <div class="zv-sec-page">
    ...
    <el-alert type="info" :closable="false" show-icon style="margin-bottom:16px">
      统一安全策略管理。在「防火墙 / USB管控 / 程序管控 / 文件保护」各模块页面通过结构化表单创建并下发策略；本页面用于管理已有策略：启用/禁用、绑定范围、版本回滚、查看执行结果、删除。
    </el-alert>
...
const types = [{v:'firewall',l:'防火墙'},{v:'usb',l:'USB管控'},{v:'app_control',l:'程序管控'},{v:'file_protect',l:'文件保护'},{v:'behavior',l:'行为监控'}]
const typeLabel = (v)=>({firewall:'防火墙',usb:'USB管控',app_control:'程序管控',file_protect:'文件保护',behavior:'行为监控'})[v]||v
