...
@router.get("/api/v1/software/packages")
def get_packages(
...
@router.post("/api/v1/software/packages/upload")
...
@router.get("/api/v1/software/packages/categories")
...
@router.get("/api/v1/software/packages/stats")
...
@router.get("/api/v1/software/packages/{package_id}")
...
@router.put("/api/v1/software/packages/{package_id}")
...
@router.get("/api/v1/software/packages/download/{package_id}")
...
@router.get("/api/v1/software/tasks")
def get_tasks(
    page: int = Query(1, ge=1),
    page_size: int = Query(20, ge=1, le=500),
...
@router.get("/api/v1/software/tasks/stats")
def get_task_stats(
    task_type: Optional[str] = None,
    software_name: Optional[str] = None,
    status: Optional[str] = None,
...
@router.get("/api/v1/software/tasks/{task_id}")
...
@router.delete("/api/v1/software/tasks/{task_id}")
...
@router.put("/api/v1/software/tasks/{task_id}/cancel")
...
@router.put("/api/v1/software/tasks/{task_id}/retry")
...
@router.post("/api/v1/software/agent/policies")
...
@router.post("/api/v1/software/agent/tasks/poll")
...
@router.delete("/api/v1/software/packages/{package_id}")
...
@router.put("/api/v1/software/task-results/{result_id}")
@router.put("/api/v1/software/agent/task-results/{result_id}")
...
@router.post("/api/v1/software/task-results/{result_id}/logs")
...
@router.get("/api/v1/software/health")
def health_check():
    """健康检查"""
    conn = get_db_connection()
    if not conn:
...
@router.get("/api/v1/software/whitelist")
def get_whitelist(
    page: int = Query(1, ge=1),
    page_size: int = Query(20, ge=1, le=500)
):
...
@router.post("/api/v1/software/whitelist")
...
@router.put("/api/v1/software/whitelist/{rule_id}")
...
@router.delete("/api/v1/software/whitelist/{rule_id}")
...
@router.get("/api/v1/software/policies")
...
@router.post("/api/v1/software/policies")
...
@router.put("/api/v1/software/policies/{policy_id}")
...
@router.delete("/api/v1/software/policies/{policy_id}")
...
@router.get("/api/v1/software/compliance/checks")
...
@router.post("/api/v1/software/compliance/checks")
...
@router.put("/api/v1/software/compliance/checks/{check_id}")
...
@router.delete("/api/v1/software/compliance/checks/{check_id}")
...
@router.get("/api/v1/software/compliance/results")
...
@router.get("/api/v1/software/compliance/stats")
...
@router.get("/api/v1/software/compliance/results/export")
